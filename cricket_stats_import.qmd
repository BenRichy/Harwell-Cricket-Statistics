...
cricket_database <- src_sqlite(FP_data_base, create = TRUE)

copy_to(cricket_database, data_players)
copy_to(cricket_database, data_batting)
copy_to(cricket_database, data_partnerships)
copy_to(cricket_database, data_bowling)
